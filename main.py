...
from conversation import clean_input, normalize_question, normalize_greeting, normalize_wellbeing
import time
import random
...
while True:
    ...
    if user.lower().startswith("forget what you know about "):
        question = user[27:].strip()
        forget_fact(knowledge, question)
        continue
